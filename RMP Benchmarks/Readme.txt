...
The Number of Users and Permissions, the Ocuppancy Rate, an Upper Bound on the minimum number of Roles (RUB) as well as the best known solutions (BEST) are given in the Tables below.
